...
Squazzoni, Flaminio; __Akbaritabar, Aliakbar__ (2017) _Internationalizing Sociology in Italy, 1970s-2010s_, Global Dialogue, ISA (International Sociological Association), Volume 7, Issue 3, 10-11 [here](https://globaldialogue.isa-sociology.org/internationalizing-sociology-in-italy-1970s-2010s/) & [here](https://globaldialogue.isa-sociology.org/wp-content/uploads/2017/08/v7i3-english.pdf)
...
__Akbaritabar, Aliakbar__; Hezarjaribi, Jafar; Jullien, Nicolas (2015) _A tool for dynamic measurement of social capital embedded in Online Social Networks_, Grafo working papers, electronic journal, Issue 4, Nº 04/y1. ISSN: 2014-5993 [(Access here)](https://revistes.uab.cat/grafowp/article/view/14/vol4-n1-Akbaritabar)
...
__Akbaritabar, Aliakbar__; Zhao, Xinyi; Zagheni, Emilio (2022) _Internal versus international scholarly mobility and migration worldwide_, Research group of professor Vincent Lariviere, University of Montreal, Canada
...
__Akbaritabar, Aliakbar__; Vacca, Raffaele; McCarty, Christopher; Squazzoni, Flaminio (2020) _Organized Track: Network Analysis for the Science of Science_, 40th INSNA Sunbelt conference (Virtual), 13-17/07/2020, Online [(Access here)](https://www.pfeffer.at/sunbelt/talks/track_30.html)
...
01/10/2020, Online [(Access here)](https://www.peere.org/conference/) (talk given by Dimity Stephen)

Barbato, Giovanni; __Akbaritabar, Aliakbar__ (2020) _Spatial Network Analysis of Internationalization in Higher Education field_, 40^th^ INSNA Sunbelt conference (Virtual), 13-17/07/2020, Online [(Access here)](https://www.pfeffer.at/sunbelt/talks/track_30.html)

__Akbaritabar, Aliakbar__; Stahlschmidt, Stephan (2019) _Merits and Limits: Applying open data to monitor Open Access publications in bibliometric databases_, 17^th^ International Conference on  Scientometrics & Informetrics (ISSI), Sapienza University, 2-5/09/2019, Rome, Italy [(Access here)](https://issi-society.org/publications/issi-conference-proceedings/)
...
__Akbaritabar, Aliakbar__; Squazzoni, Flaminio (2018) _Tweet review: a network study on tweets about peer review_, PEERE (New Frontiers of Peer Review) conference, 7-9/03/2018, CNRS, Rome, Italy [here](https://www.peere.org/conference/conference-programme/) and [here](https://www.facebook.com/akbaritabar/posts/1891979047479423?pnref=story)
...
- Teaching  more than [__10 workshops__](https://goo.gl/3L6j2U) about how to formulate research problems and do network analysis using Pajek and NodeXL [__visual history here__](https://goo.gl/3L6j2U)
...
- Member of __GECS__: Research Group on Experimental and Computational Sociology (more [here](https://gecs.unibs.it/) & [here](https://www.facebook.com/gecsbrescia))
...
- __Academic English Writing__ (9/04/2019)
    ...
    + __Instructor__: [Tim Korver](https://www.timkorver.com/)
...
- Interview with M@rsouin institute about Social Village [(__here__](https://www.marsouin.org/article667.html) and [__here__)](https://www.imt-atlantique.fr/lexians/2015/recherche/les-reseaux-sociaux-un-moyen-daugmenter-son-capital-social-interview-de-aliakbar-akbaritabar-doctorant-iranien/)
