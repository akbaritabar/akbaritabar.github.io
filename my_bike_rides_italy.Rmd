...
```{r leiden bike rides, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r leiden runs, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r holand walks, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r ireland activities, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
