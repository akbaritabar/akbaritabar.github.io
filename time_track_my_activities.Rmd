...
<!-- ### Comparative trends of activities and categories over time -->
...
<!-- ### Other trends to consider (point 7 on my notes) -->
<!-- - you can add more detailed questions like "what research activity I have spend the most time on?" or "how has been the trend of my workouts in this year?" -->


## Closing words
This has been another practice for me in using R to analyze and generate a dynamic report based on real empirical data and also to get better in writing code and scripts with expressive and useful comments that can be used to teach R to newbies. Beside that it was an opportunity to know myself better. To have a detailed view towards my research and hobby activities. But, this is not yet finished, I hope to put time on adding other ideas to make this report more insightful first for myself, then to other interested people.